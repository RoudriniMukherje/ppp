...
if(isset($_POST['submit'])){
  ...
  try{
    ...
    $mail->SMTPAuth = true;
    $mail->Username = 'roudrinimukherjee@gmail.com'; // Gmail address which you want to use as SMTP server
    $mail->Password = 'babun1234@'; // Gmail address Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port = '587';

    $mail->setFrom('roudrinimukherjee@gmail.com'); // Gmail address which you used as SMTP server
    $mail->addAddress('roudrinimukherjee@gmail.com'); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)
